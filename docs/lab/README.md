...
| [long](long.md) | Chạy dài gấp ba thì có gì xuất hiện muộn không? | default 1/4; bare 0/4 | bare: signal_mi −0.03 |
| [pace](pace.md) | Đất có phải là cái tạo nhịp dao động không? | default 1/4; fragile 0/4; tough 0/4 | fragile: settled_share −0.39; fragile: signal_mi −0.03; tough: soil_health +0.12; tough: lived_soil +0.12 |
| [food](food.md) | Thức ăn có phải là cái tạo nhịp không? | default 1/4; fast-regrow 1/4; slow-regrow 0/4 | fast-regrow: breed_rate +6.16; fast-regrow: swing −6.15; slow-regrow: signal_meaning +0.06 |
